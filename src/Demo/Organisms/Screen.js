...
import Diagram from "../../Library/Organisms/Diagram";
  ...
  return (
    <Box parse="pa:10%">
      <Box parse="d:flex fd:column a:center">
        <a href="https://github.com/juliangumenita/simple-effing-diagram">
          <img
            alt="simple-effing-diagram"
            src="https://raw.githubusercontent.com/juliangumenita/simple-effing-diagram/main/src/Demo/Assets/Header.svg"
          />
        </a>
        <br />
        <div align="center">
          <strong>Simple f*cking diagram for React.</strong>
        </div>
      ...
      <Box parse="mt:100">
        <Diagram
          press={(item) => console.log({ item })}
          items={items}
          change={(items) => _items(items)}
        />
      </Box>
    </Box>
  );
